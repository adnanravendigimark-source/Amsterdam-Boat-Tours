            ...
            <SectionCard title="Basics" description="What readers see as the title, and where the page lives.">
              <Field label="Title (H1 on the page)">
                <input
                  ...
                  placeholder="e.g. Best Time for a Amsterdam Canal Cruise"
                />
              </Field>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                >
                  <input
                    ...
                    placeholder="best-time-for-an-amsterdam-canal-cruise"
                  />
                </Field>
              ...
              <Field label="Author" hint='Shown as the byline on the article ("By <name>"). Format: "Name / Role", e.g. "Emma de Vries / Amsterdam Local Guide".'>
                <input
                  value={post.author}
                  onChange={(e) => update("author", e.target.value)}
                  className={inputClass}
                  placeholder="e.g. Emma de Vries / Amsterdam Local Guide"
                />
              </Field>
